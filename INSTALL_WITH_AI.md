...
Before v0.2 publication, the current trusted route is a local source build. 在 v0.2 发布前，当前受信任路径是本地源码构建。Run `pnpm plugin:package`, retain the resulting archive identity, and install the verified `dist/plugin/fantasy-mouse-ui.zip`.
