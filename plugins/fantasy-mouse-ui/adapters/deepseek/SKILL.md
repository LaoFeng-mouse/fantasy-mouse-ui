...
description: Load the shared Fantasy Mouse UI contract in DeepSeek.
---

# DeepSeek loading adapter

Use DeepSeek's available file-reading, command-running, and real image-viewing capabilities only to load the shared plugin contract.
