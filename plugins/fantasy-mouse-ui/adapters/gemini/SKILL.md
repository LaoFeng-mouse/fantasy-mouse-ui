...
description: Load the shared Fantasy Mouse UI contract in Gemini.
---

# Gemini loading adapter

Use Gemini's available file-reading, command-running, and real image-viewing capabilities only to load the shared plugin contract.
