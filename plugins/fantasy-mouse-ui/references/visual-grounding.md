...
Preserve these anchors together:
...
Do not replace the character with a generic cute mouse, anime mascot, polished 3D animal, icon, emoji, or vector approximation. Preserve the intentional contrast between the strange photographic face and the minimal drawn body.
...
- Attach forearms below the grey-head/white-body seam, never to the face or cheeks.
...
Vary state expression intensity, pose, clothes, profession, tools, props, vehicles, awards, partners, background, motion, and fantasy scene. Keep the face, teeth, ears, head/body relationship, silhouette, proportions, and temperament recognizable.
